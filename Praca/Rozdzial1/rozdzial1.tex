...
Kolejne rozdziały skupiają się na analizie głównych funkcjonalności wybranych bibliotek pod kątem zastosowań w biostatystyce. Czwarty rozdział przedstawia bibliotekę Shogun, piąty zapoznaje użytkownika z biblioteką Shark-ML, natomiast szósty omawia bibliotekę Dlib. Wprowadzają one czytelnika kolejno w poszczególne aspekty pracy z wybranym produktem, od akceptowanych formatów danych, przez manipulację obserwacjami, po dostępne modele i metody ich analizy. Każdy z rozdziałów podsumowany jest testami na danych biostatystycznych omówionych w rozdziale 3, wraz z analizą skuteczności modelu za pomocą dostępnych dla danej biblioteki metod.

Rozdział siódmy zestawia podobieństwa i różnice między bibliotekami w obiektywnej formie tabelarycznej, i subiektywnej opinii słownej autora na podstawie jego doświadczeń z implementacją rozwiązań i pracą ze źródłami wiedzy.