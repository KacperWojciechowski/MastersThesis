...
\cppcode{Result/inc/shogun/linear.hpp}{Przykład regresji liniowej w Shogu}{shogun:linear}
...
\cppcode{Result/inc/shogun/neural.hpp}{Przykład użycia sieci neurnowej}{shogun:nn}
...
\cppcode{Rozdzial4/shogun-mae.cpp}{Przykład obliczenia wartości średniego błędu absolutnego \cite{handsOnMachineLearning}}{shogun:mae}
