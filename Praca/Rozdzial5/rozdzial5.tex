...
\cppcode{Rozdzial5/shark-neural.cpp}{Przykład trójwarstwowej sieci neuronowej \cite{handsOnMachineLearning}}{shark:neural}
...
\cppcode{Result/test.cpp}{Napisany dotychczasowo kod}{label}

%\cppcode{Rozdzial5/shark-res-main.cpp}{Funkcja main() programu testowego}{shark:res-main.cpp}

\subsection{Regresja logistyczna}

KOD DO PRZETESTOWANIA

%\cppcode{Rozdzial5/shark-res-logistic.cpp}{Kod realizujący uczenie z wykorzystaniem regresji logistycznej}{shark:res-logistic}

\subsection{Maszyna wektorów nośnych}

KOD DO PRZETESTOWANIA

%\cppcode{Rozdzial5/shark-res-svm.cpp}{Kod realizujący uczenie z wykorzystaniem maszyny wektorów nośnych}{shark:res-svm}

\subsection{Sieć neuronowa}

KOD DO PRZETESTOWANIA

%\cppcode{Rozdzial5/shark-res-neural.cpp}{Kod realizujący uczenie z wykorzystaniem sieci neuronowej}{shark:res-neural}