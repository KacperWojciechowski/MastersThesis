...
\newcommand{\ccode}[2]{\vspace{8pt}\lstinputlisting[caption=#2, style=praca, language=C, label=lst:listing, xleftmargin=.02\textwidth, xrightmargin=.02\textwidth]{#1}}
\newcommand{\cppcode}[2]{\vspace{8pt}\lstinputlisting[caption=#2, style=praca, language=C++, label=lst:listing, xleftmargin=.02\textwidth, xrightmargin=.02\textwidth]{#1}}
