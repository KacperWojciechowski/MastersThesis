...
%==========================================================================================
\author{Kacper Wojciechowski, B.CS}
\kierunek{Computer Science}
\grupa{21 INF-ZSI-SD}		% np. 101AiRDz
\title{Comparative analysis of machine learning libraries in C++ for applications in biostatistics}
\tytulAngielski{}
\uczelnia{Uniwersity of Zielona Góra}
\wydzial{Faculty of Computer, Electrical and Control Engineering}
\praca{Master's Thesis} % pozostawić właściwe
\promotor{prof. dr hab. eng. Dariusz Uciński}
\konsultant{} 	% nie usuwać w~przypadku braku lecz pozostawić puste czyli: \konsultant{}
%\konsultant{}
\miasto{Zielona Góra}
\miesiac{June}	% miesiąc złożenia pracy
\rok{2023}
